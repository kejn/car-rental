...
@Entity
@Table(name = AllCars.viewName)
public class AllCars {
	
	protected static final String viewName = "ALLCARS";
	...
	public AllCars(BigDecimal id, ModelEntity model, ColorEntity color, BodyEntity body,
	...
	public CarEntity toEntity() {
		return new CarEntity(id, model, color, body, transmission, driveWheels, location, weight, power);
	}
